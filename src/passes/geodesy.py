...
the equatorial. Modules here that assume a spherical Earth —
:mod:`passes.guidance.entry` and :mod:`passes.orbital.fobs` — are doing so
for the guidance structure rather than for the geometry, and a
...
#: Earth's sidereal rotation rate (rad/s), matching :mod:`passes.orbital.fobs`.
