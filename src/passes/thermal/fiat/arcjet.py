...
The oxyacetylene-torch experiments in :mod:`passes.thermal.fiat.quinn` are
...
def _m(
    c: str, t: float, i: str, o: str | None, s: float | None, k: float | None
) -> ArcjetModel:
...
MODELS: tuple[ArcjetModel, ...] = (
    _m("1", 55, "AA-43-209-N", "A", 2.33, 2033), _m("1", 55, "AA-43-210-N", "A", 2.27, 2041),
    _m("2a", 200, "AT-008", None, 12.66, 2177), _m("2b", 400, "AT-007", None, 24.72, 2196),
    _m("3a", 33, "AA-44-210-N", "B", 2.93, 2161), _m("3a", 33, "AA-44-211-N", "B", 2.92, 2174),
    _m("3b", 66, "AA-44-212-N", "B", 5.61, 2163),
    _m("4a", 33, "AA-43-211-N", "A", 2.27, 2243), _m("4a", 33, "AA-43-212-N", "A", 2.20, 2245),
    _m("4b", 60, "AA-43-208-N", "A", 4.28, 2248), _m("4b", 60, "1403", "D", 4.58, 2259),
    _m("4b", 60, "1404", "D", 4.76, 2284),
    _m("5a", 30, "AA-44-204-N", "B", 4.78, 1989), _m("5a", 30, "AA-44-205-N", "B", 3.79, 2004),
    _m("5b", 60, "AA-44-206-N", "B", 8.81, 2065),
    _m("6a", 42, "AA-43-213-N", "A", 3.71, 2407), _m("6a", 42, "AA-43-215-N", "A", 3.65, 2414),
    _m("6a", 42, "AA-43-207-N", "A", 3.95, 2401), _m("6a", 42, "AA-43-216-N", "B", 3.52, 2432),
    _m("6a", 42, "AA-43-227-N", "B", 3.68, 2419), _m("6a", 42, "1405", "D", 4.12, 2437),
    _m("6a", 42, "1406", "D", 3.69, 2417),
    _m("6b", 60, "AA-43-223-N", "A", 5.21, 2434), _m("6b", 60, "AA-43-228-N", "A", 5.23, 2409),
    _m("7a", 30, "AA-44-201-N", "B", 3.87, 2331), _m("7a", 30, "AA-44-202-N", "B", 4.33, 2320),
    _m("7b", 60, "AA-44-203-N", "B", 8.52, 2359),
    _m("8", 34, "AA-43-219-N", "B", 4.61, 2730), _m("8", 34, "AA-43-218-N", "B", 4.43, 2735),
    _m("9", 120, "AT-011", None, 16.45, 2703), _m("9", 120, "AT-019", None, 18.66, 2718),
    _m("9", 120, "AT-025", None, 19.06, 2713), _m("9", 120, "AT-026", None, 19.03, 2697),
    _m("9", 120, "AA-40-001", None, 17.71, 2682), _m("9", 120, "AA-40-002", None, 17.64, 2677),
    _m("9", 120, "AA-40-003-N", None, 16.25, 2662),
    _m("10a", 34, "AA-44-207-N", "B", 6.32, 2757), _m("10a", 34, "AA-44-208-N", "B", 6.58, 2764),
    _m("10b", 68, "AA-44-209-N", "B", 13.63, 2738),
    _m("11a", 30, "AA-43-221-N", "B", 4.18, 2990), _m("11a", 30, "AA-43-224-N", "B", 4.55, 2923),
    _m("11a", 30, "AA-43-226-N", "B", 4.30, 2943),
    _m("11b", 40, "AA-43-222-N", "B", 5.89, 2988), _m("11b", 40, "AA-43-225-N", "B", 5.92, 2934),
    _m("12", 30, "AA-43-233-N", "B", 5.41, 2963), _m("12", 30, "AA-43-234-N", "B", 4.97, 2963),
    _m("13", 70, "AT-012", None, 12.57, 2984), _m("13", 70, "AT-020", None, 14.56, 3030),
    _m("13", 70, "AT-027", None, 15.00, 3053), _m("13", 70, "AT-028", None, 15.33, 3015),
    _m("13", 70, "AA-40-003", None, 13.82, 2994), _m("13", 70, "AA-40-004", None, 11.58, 2994),
    _m("13", 70, "AA-40-001-N", None, 13.79, 2969), _m("13", 70, "AA-40-002-N", None, 12.83, 2984),
    _m("14", 27, "AA-44-218-N", "C", 5.13, 3030),
    _m("15", 45, "AA-44-223-N", "C", 12.74, 3098), _m("15", 45, "AA-44-224-N", "C", 12.91, 3098),
    _m("16a", 30, "AT-001", None, 11.97, 3020), _m("16a", 30, "AT-004", None, 11.33, 3051),
    _m("16b", 40, "AT-003", None, 15.15, 3020), _m("16b", 40, "AT-005", None, 15.56, 3030),
    _m("17", 10, "AA-44-219-N", "C", 4.84, 3233),
    _m("18a", 113, "AT-009", None, None, 2728), _m("18b", 128, "AT-009", None, 26.95, 2218),
    _m("18a", 113, "AT-010", None, None, 2738), _m("18b", 128, "AT-010", None, 27.05, 2213),
...
def recession_statistics(condition_number: str) -> tuple[float, float, float]:
    ...
    """
    values = [
        m.recession for m in models_for(condition_number) if m.recession is not None
    ]
    if not values:
