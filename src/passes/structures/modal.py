...
from passes.structures.beam import BeamOperators
from passes.structures.boundary import FreeFreeProjection, free_free_constraints
...
def solve_free_free_modes(
    ...
    projection:
        ...
        :func:`~passes.structures.boundary.project_free_free`.
    imag_tol:
