...
against :func:`passes.aerodynamics.conical.solve_cone` — a 15-degree cone at
...
from passes.aerodynamics.cfd.meshing import (
    BodyProfile,
    DomainSizing,
    MeshResult,
    axisymmetric_domain,
...
from passes.aerodynamics.cfd.solver import (
    EulerSolver,
    GridConvergence,
    grid_convergence,
)
from passes.aerodynamics.cfd.su2 import (
    SU2Result,
    SU2Settings,
    find_su2,
    run_su2,
