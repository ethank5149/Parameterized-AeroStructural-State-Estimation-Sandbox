...
:class:`~passes.flight.simulator.FlightSimulator` integrated an *unpowered*
...
:mod:`passes.orbital.scenario` instead — a **geometry** model of stitched
Keplerian conics with a prescribed pitch program.

That split is the same defect :class:`~passes.viz.history.SimulationHistory`
