...
more than an order of magnitude between solar minimum and maximum, and a
FOBS parking orbit at 170 km or an HGV skipping at 90 km is sensitive to
exactly that.
...
:class:`~passes.atmosphere.model.LayeredAtmosphere` blends across it rather
...
from passes.atmosphere.standard import AVOGADRO, BOLTZMANN, AtmosphereState
...
class MSISAtmosphere:
    """NRLMSIS as an :class:`~passes.atmosphere.standard.AtmosphereState` source.
