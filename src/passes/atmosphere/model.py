...
class LayeredAtmosphere:
    ...
    def state(self, altitude: ArrayLike) -> AtmosphereState:
        ...
        from passes.atmosphere.standard import UNIVERSAL_GAS_CONSTANT
...
def earth_atmosphere(
    ...
    a factor of ten between :data:`~passes.atmosphere.upper.SOLAR_MINIMUM`
    and :data:`~passes.atmosphere.upper.SOLAR_MAXIMUM`.
    """
